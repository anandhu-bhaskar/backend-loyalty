...
// const contractJson = fs.readFileSync('./contract/TrothToken.json');
// const trothTokenABI = JSON.parse(contractJson);
...
exports.claimReward = async (req, res) => {
    const user = await User.findById(req.userData.userId);
    const { to, amount } = {to:user.ethereumAddress,amount:100000}
